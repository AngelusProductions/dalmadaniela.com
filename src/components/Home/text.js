export default {
  ...
  titleTagline: 'Social media for everyone',
  ...
  filmsText: 'Dalma has used my social media influence to promote the projects that have cast me as an actress and launched successful crowdfunding campaigns that have funded the entire pre and post production of her latest feature film.',
